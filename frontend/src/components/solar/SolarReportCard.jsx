    ...
    <Card sx={{borderRadius: '2rem'}}>
      ...
      <CardContent>
        <div className="grid grid-cols-1 gap-4 mb-4">
          <SolarTimeRow icon={<WbSunnyIcon />} label="Sunrise" time={times.sunrise} />
          <SolarTimeRow icon={<WbSunnyIcon />} label="Solar Noon" time={times.solarNoon} />
          <SolarTimeRow icon={<WbSunnyIcon />} label="Sunset" time={times.sunset} />
        </div>
      </CardContent>
      ...
      <CardActions disableSpacing>
        ...
        {onSave && (
          <IconButton aria-label="save" onClick={handleSaveClick} color="primary">
            <SaveIcon />
          </IconButton>
        )}
        <ExpandMore
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <div className="grid grid-cols-1 gap-2">
            <SolarTimeRow icon={<Brightness3Icon />} label="Night End" time={times.nightEnd} />
            <SolarTimeRow icon={<WbSunnyIcon />} label="First Light" time={times.firstLight} />
            <SolarTimeRow icon={<AccessTimeIcon />} label="Dawn" time={times.dawn} />
            <SolarTimeRow icon={<AccessTimeIcon />} label="Dusk" time={times.dusk} />
            <SolarTimeRow icon={<WbSunnyIcon />} label="Last Light" time={times.lastLight} />
            <SolarTimeRow icon={<Brightness3Icon />} label="Night Begin" time={times.nightBegin} />
            {times.timezone && (
